...
temperatures <- fread(file = "inputs/donnees-de-temperature-et-de-pseudo-rayonnement.csv")
...
temperatures[, date := as.Date("2024-01-01") + (seq_len(.N) - 1)]
...
setDF(temperatures)
saveRDS(temperatures, "datas/temperatures.rds")
